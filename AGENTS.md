...
- Confirm target Python version matches the version stated in EDMC core `docs/Releasing`; baseline (verified 2026-09-07 against upstream `docs/Releasing.md`) is Python 3.13.9 32-bit for Windows builds. Update this file if the baseline changes. This applies to the EDMC plugin runtime; the controller/client run in their own environments and require Python >= 3.10.
